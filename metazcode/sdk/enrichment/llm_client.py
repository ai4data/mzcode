"""
LLM Client for Node Enrichment

This module provides a clean interface to Large Language Models for generating
business-focused summaries of technical metadata.
"""
...
class OpenAIEnricher:
    """
    OpenAI-based enricher for generating business summaries.
    ...
    def _call_openai(self, prompt: str) -> Optional[str]:
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert AI Data Architect analyzing ETL metadata."},
